  ...
  create  table "postgres"."public_pipedrive_intermediate"."int_activity_filtered__dbt_tmp"
...
from deduped
left join "postgres"."public_pipedrive_staging"."stg_activity_types" at on deduped.activity_type = at.activity_type
where rn = 1
